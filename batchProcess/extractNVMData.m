function [standardCams, points3D] = extractNVMData(nvmFileName)
...
standardCams = convertToStandardCams(camera);
save(fullfile(pathstr, [name, '.mat']),'standardCams', 'points3D');
